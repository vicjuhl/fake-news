...
class SVCModel(BaseModel):
    ...
    def __init__(
        ...
        super().__init__(params, training_sets, val_set, models_dir, t_session, "svc", "pkl") # had to choose BaseModel inheritance (instead of LinearModel), since we wish to include the last two parameters here
